package com.abastos.minhasfinancas.api.resource;
...
import com.abastos.minhasfinancas.api.dto.AtualizaStatusDTO;
import com.abastos.minhasfinancas.api.dto.LancamentoDTO;
	...
	public ResponseEntity atualizarStatus(@PathVariable("id") Long id,@RequestBody AtualizaStatusDTO dto) {
		return service.obterPorId(id).map( entity ->{
			...
			if(statusSelecionado == null) {
				return ResponseEntity.badRequest().body("Não foi possível atualizar o status de lancamento,envie um status válido");
			}
